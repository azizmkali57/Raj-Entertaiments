...
const FEATURES = [
  ...
  { icon: Heart, title: "Client First", desc: "Every celebration revolves around your happiness." },
];
...
const MILESTONES = [
  ...
  },
  {
    ...
    img: "https://images.unsplash.com/photo-1470229722913-7c0e2dbbafd3?q=80&w=400&auto=format&fit=crop",
  },
  {
    year: "2021",
    title: "Industry Recognition",
    desc: "Recognized as one of Central India's leading event management companies.",
    img: "https://images.unsplash.com/photo-1492684223066-81342ee5ff30?q=80&w=400&auto=format&fit=crop",
  },
  {
    year: "2024+",
    title: "The Future Ahead",
    desc: "Continuing to innovate and create extraordinary experiences.",
    img: "https://images.unsplash.com/photo-1533174072545-7a4b6ad7a6c3?q=80&w=400&auto=format&fit=crop",
  },
];
...
const LEADERS = [
  {
    name: "Raj Malhotra",
    role: "Founder & CEO",
    desc: "The visionary behind Raj Entertainments. His passion drives our success.",
    img: "https://images.unsplash.com/photo-1560250097-0b93528c311a?q=80&w=500&auto=format&fit=crop",
  },
  {
    name: "Priya Malhotra",
    role: "Creative Director",
    desc: "The creative force who turns ideas into magical experiences.",
    img: "https://images.unsplash.com/photo-1580489944761-15a19d654956?q=80&w=500&auto=format&fit=crop",
  },
  {
    name: "Vikram Singh",
    role: "Operations Head",
    desc: "The man who ensures flawless execution of every detail.",
...
const MISSION_ITEMS = [
  { icon: Target, title: "Deliver Excellence", desc: "To deliver exceptional events that exceed expectations." },
  { icon: Heart, title: "Build Lasting Relationships", desc: "To build lasting relationships based on trust and excellence." },
  { icon: Rocket, title: "Innovate Continuously", desc: "To innovate and set new benchmarks in the event industry." },
];
...
function AmbientBackground() {
  return (
    <div className="pointer-events-none absolute inset-0 overflow-hidden">
      <div className="absolute inset-0 opacity-[0.04]" style={{ backgroundImage: NOISE_BG }} />
      <div
      ...
      />
      {/* vignette */}
      <div className="absolute inset-0" style={{ background: "radial-gradient(120% 100% at 50% 0%, transparent 40%, rgba(9,9,9,0.9) 100%)" }} />
      {PARTICLES.map((p) => (
        <motion.span
          key={p.id}
          className="absolute rounded-full"
          style={{ left: p.left, width: p.size, height: p.size, bottom: "-4%", background: PRIMARY }}
...
function Counter({ value, suffix }) {
  ...
  return (
    <span ref={ref} className="font-serif text-3xl sm:text-4xl" style={{ color: HEADING }}>
      {display}
  ...
  return (
    <section className="relative flex min-h-screen flex-col lg:flex-row">
      ...
      <div className="relative z-10 flex flex-col justify-center px-6 py-20 sm:px-10 lg:w-[48%] lg:px-16 lg:py-24">
        ...
        <h1 className="mt-5 font-serif text-4xl leading-[1.1] sm:text-5xl lg:text-[3.4rem]" style={{ color: HEADING }}>
        ...
        >
          <p>
            Raj Entertainments is a full-service event management and entertainment company dedicated to
            creating extraordinary experiences that leave lasting impressions.
          </p>
          <p>With creativity, precision and passion, we bring every celebration to life with seamless execution and unforgettable memories.</p>
        </motion.div>
        ...
        >
          Discover Our Story
          <motion.span variants={{ hover: { x: 6 } }} transition={{ duration: 0.3 }}>
        ...
        <div className="mt-10 grid grid-cols-1 gap-4 sm:grid-cols-3">
          {FEATURES.map((f, i) => (
            <motion.div
              ...
              style={{ background: "rgba(20,20,20,0.5)", border: `1px solid ${BORDER}` }}
              onMouseEnter={(e) => (e.currentTarget.style.boxShadow = `0 16px 40px -20px ${GLOW}`)}
              onMouseLeave={(e) => (e.currentTarget.style.boxShadow = "none")}
            >
              <f.icon size={18} style={{ color: PRIMARY }} strokeWidth={1.6} />
              <h3 className="mt-3 text-xs font-semibold uppercase tracking-wide" style={{ color: HEADING }}>
                {f.title}
              </h3>
              <p className="mt-2 text-xs leading-relaxed" style={{ color: PARA }}>
                {f.desc}
              </p>
            </motion.div>
          ))}
      ...
      <div
        ...
        className="relative h-[60vh] overflow-hidden lg:h-auto lg:w-[52%] lg:rounded-l-[24px]"
      >
        ...
        <div className="absolute inset-0" style={{ background: `linear-gradient(to top, ${BG}, rgba(9,9,9,0.25), rgba(9,9,9,0.1))` }} />
        <div className="absolute inset-0 hidden lg:block" style={{ background: `linear-gradient(to right, ${BG}, rgba(9,9,9,0.05), transparent)` }} />
        <div className="absolute inset-0 opacity-60" style={{ background: `radial-gradient(60% 50% at 65% 40%, ${GLOW}, transparent 70%)` }} />

        {PARTICLES.slice(0, 10).map((p) => (
          <motion.span
            key={p.id}
            className="absolute rounded-full"
            style={{ left: p.left, width: p.size, height: p.size, bottom: "-5%", background: PRIMARY }}
        ...
        <div className="absolute bottom-10 left-10 hidden lg:block">
          <span className="font-serif text-6xl" style={{ color: "rgba(245,245,245,0.9)" }}>
            R
          </span>
        </div>
      </div>
      ...
      >
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-[minmax(0,320px)_1fr] lg:items-center lg:gap-16">
          <div>
            ...
            <h2 className="mt-4 font-serif text-3xl leading-tight sm:text-4xl" style={{ color: HEADING }}>
              NUMBERS THAT DEFINE <span style={{ color: PRIMARY }}>OUR JOURNEY</span>
            </h2>
            <p className="mt-4 text-sm leading-relaxed" style={{ color: PARA }}>
              Every event we create adds to our legacy of trust, creativity and excellence.
            </p>
          </div>

          <div className="grid grid-cols-2 gap-6 sm:grid-cols-3 lg:grid-cols-5 lg:divide-x" style={{ borderColor: BORDER }}>
            {STATS.map((stat, i) => (
              <motion.div
                key={stat.label}
                initial={{ opacity: 0, y: 24 }}
              ...
              >
                <stat.icon size={20} style={{ color: PRIMARY }} strokeWidth={1.6} />
                <div className="mt-3">
                  <Counter value={stat.value} suffix={stat.suffix} />
                </div>
                <p className="mt-1 text-[11px] uppercase tracking-widest" style={{ color: PARA }}>
                  {stat.label}
                </p>
              </motion.div>
            ))}
      ...
      <div className="mx-auto max-w-6xl">
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-[minmax(0,300px)_1fr] lg:gap-16">
          ...
          >
            ...
            <h2 className="mt-4 font-serif text-3xl leading-tight sm:text-4xl" style={{ color: HEADING }}>
              A DECADE OF <span style={{ color: PRIMARY }}>PASSION</span> &amp; <span style={{ color: PRIMARY }}>GROWTH</span>
            </h2>
            <p className="mt-4 text-sm leading-relaxed" style={{ color: PARA }}>
              From a small beginning to becoming a trusted name in the industry, our journey has been driven by
              passion, innovation and trust.
            </p>
          </motion.div>
          ...
          <div className="relative">
            <div className="hidden lg:block">
              <div className="relative grid grid-cols-5 gap-6">
                <div className="absolute left-0 right-0 top-[38px] h-px" style={{ background: BORDER }} />
                {MILESTONES.map((m, i) => (
                  <motion.div
                    key={m.year}
                  ...
                  >
                    <div className="relative h-[76px] w-[76px] overflow-hidden rounded-full" style={{ border: `2px solid ${PRIMARY}` }}>
                      <img src={m.img} alt={m.title} className="h-full w-full object-cover transition-transform duration-500 hover:scale-125" />
                    </div>
                    <span className="relative z-10 mt-3 block h-2 w-2 rounded-full" style={{ background: PRIMARY }}>
                      <motion.span
                    ...
                    <p className="mt-3 font-serif text-lg" style={{ color: PRIMARY }}>
                      {m.year}
                    </p>
                    <h3 className="mt-1 text-xs font-semibold uppercase tracking-wide" style={{ color: HEADING }}>
                      {m.title}
                    </h3>
                    <p className="mt-2 text-xs leading-relaxed" style={{ color: PARA }}>
                      {m.desc}
              ...
              {MILESTONES.map((m, i) => (
                ...
                >
                  <div className="flex flex-col items-center">
                    <div className="h-16 w-16 shrink-0 overflow-hidden rounded-full" style={{ border: `2px solid ${PRIMARY}` }}>
                      <img src={m.img} alt={m.title} className="h-full w-full object-cover" />
                    </div>
                    {i < MILESTONES.length - 1 && <div className="mt-2 w-px flex-1" style={{ background: BORDER }} />}
                  </div>
                  <div className="pb-4">
                    <p className="font-serif text-lg" style={{ color: PRIMARY }}>
                      {m.year}
                    </p>
                    <h3 className="mt-1 text-xs font-semibold uppercase tracking-wide" style={{ color: HEADING }}>
                      {m.title}
  ...
  return (
    <section className="px-6 py-16 sm:px-10">
      <motion.div
        ...
        style={{ background: `linear-gradient(135deg, #150707, ${BG})`, border: `1px solid ${BORDER}` }}
      >
        <motion.div
        ...
        <div className="relative grid grid-cols-1 gap-10 p-8 sm:p-12 lg:grid-cols-2 lg:gap-16 lg:p-16">
          <div>
            ...
            <h2 className="mt-4 font-serif text-3xl leading-tight sm:text-4xl" style={{ color: HEADING }}>
              WE DON'T JUST PLAN EVENTS, WE <span style={{ color: PRIMARY }}>CREATE EMOTIONS</span>
            </h2>
            <p className="mt-4 text-sm leading-relaxed" style={{ color: PARA }}>
              Every celebration tells a story, and our mission is to transform ideas into unforgettable
              experiences filled with emotion and elegance.
            </p>
            ...
            <div className="mt-8 space-y-5">
              {MISSION_ITEMS.map((item, i) => (
                <motion.div
                  ...
                  style={{ borderBottom: i < MISSION_ITEMS.length - 1 ? `1px solid ${BORDER}` : "none" }}
                >
                  <item.icon size={18} className="mt-0.5 shrink-0" style={{ color: PRIMARY }} />
                  <div>
                    <h3 className="text-sm font-semibold" style={{ color: HEADING }}>
                      {item.title}
                    </h3>
                    <p className="mt-1 text-xs leading-relaxed" style={{ color: PARA }}>
                      {item.desc}
                    </p>
                  </div>
                </motion.div>
          ...
          <div className="relative min-h-[320px] overflow-hidden rounded-[20px]">
            <motion.img
              ...
              alt="Live event crowd with confetti and stage lighting"
              initial={{ scale: 1.1 }}
            ...
            <button
              ...
              className="absolute left-1/2 top-1/2 flex h-16 w-16 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full backdrop-blur-sm"
              style={{ background: "rgba(9,9,9,0.5)", border: `1px solid ${BORDER}` }}
            >
              <motion.span
                className="absolute inset-0 rounded-full"
              ...
              />
              <Play size={20} fill={HEADING} style={{ color: HEADING }} className="ml-1" />
            </button>
            ...
            <a
              ...
              style={{ background: "rgba(9,9,9,0.7)", border: `1px solid ${BORDER}`, color: HEADING }}
            >
              Watch Our Story
              <ArrowRight size={14} className="transition-transform duration-300 group-hover:translate-x-1" style={{ color: PRIMARY }} />
            </a>
          </div>
        </div>
      </motion.div>
